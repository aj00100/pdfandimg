...
import { b3 as removeQueryString, A as AstroError, b4 as NoImageMetadata, b5 as FailedToFetchRemoteImageDimensions, b6 as RemoteImageNotAllowed, ax as joinPaths, b7 as ExpectedImage, b8 as isRemotePath$1, b9 as LocalImageUsedWrongly, ba as MissingImageDimension, bb as UnsupportedImageFormat, bc as IncompatibleDescriptorOptions, bd as UnsupportedImageConversion, be as ExpectedImageOptions, bf as ExpectedNotESMImage, bg as InvalidImageService, bh as ImageMissingAlt, v as maybeRenderHead, a0 as addAttribute, K as renderTemplate, bi as FontFamilyNotFound, bj as unescapeHTML, bk as MissingGetFontFileRequestUrl } from "./sequence_AEcFSQau.mjs";
import { i as isRemoteAllowed$1, s as spreadAttributes } from "./worker-entry_DkCG0Wsc.mjs";
...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      "./image-service-workerd_CgE-1gzy.mjs"
    ).catch((e) => {
...
async function getImage$1(options, imageConfig2) {
  ...
  if (resolvedOptions.inferSize) {
    ...
    if (isRemoteImage(resolvedOptions.src) && isRemotePath$1(resolvedOptions.src)) {
      if (!isRemoteAllowed$1(resolvedOptions.src, imageConfig2)) {
        throw new AstroError({
          ...RemoteImageNotAllowed,
...
async function peekRemoteFormatForStaticEmit(options, imageConfig2, service) {
  if (!isRemoteImage(options.src) || !isRemoteAllowed$1(options.src, imageConfig2) || !globalThis.astroAsset?.addStaticImage || !isLocalService(service) || !service.getRemoteSize) {
    return void 0;
  }
  try {
...
}, "/home/asus/mini_web/node_modules/astro/components/Image.astro", void 0);
const mimes = {
  "3g2": "video/3gpp2",
  "3gp": "video/3gpp",
  "3gpp": "video/3gpp",
...
}, "/home/asus/mini_web/node_modules/astro/components/Picture.astro", void 0);
...
}, "/home/asus/mini_web/node_modules/astro/components/Font.astro", void 0);
